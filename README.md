...
This is a project On Decentralized Stable Coin with Foundry.
...
This repository contains the Solidity code for a Decentralized Stable Coin (DSC) and its corresponding DeFi protocol engine, DSCEngine. The DSC is a stablecoin pegged to the US dollar and is backed by exogenous collateral, such as wETH and wBTC. It is designed to maintain a 1:1 peg with the US dollar, similar to DAI, but without governance, fees, or unnecessary complexity.

Key Features of the DSC:
Exogenous Collateralized: Uses external assets like wETH and wBTC to collateralize the stablecoin.
USD Pegged: Maintains a value of 1 DSC = 1 USD.
Overcollateralized System: Ensures that the total collateral value is always greater than or equal to the total DSC supply.
Algorithmic Stability: The system ensures that DSC remains stable and avoids volatility.
...
```
git clone https://github.com/Zabid27/foundry-Decentralized-Stablecoin-CU
cd foundry-Decentralized-Stablecoin-CU
forge build
```
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#github.com/Zabid27/foundry-Decentralized-Stablecoin-CU)
...
If you appreciated this, feel free to follow me or email on abidogunabdulazeez@gmail.com !
